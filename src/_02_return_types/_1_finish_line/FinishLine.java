...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		if(hasFinished) {
			JOptionPane.showMessageDialog(null, "the robot crossed the finish line and went " + totalDistance);
			
		} else {
			JOptionPane.showMessageDialog(null, "the robot did not cross the finish line and went " + totalDistance);
		}
